...
module.exports = ({ app, controllers, authentication, uploadCategoryImage }) => {
        ...
        app.get('/categories/create', authentication.isInRole('admin'), controller.getCreateCategory);
        app.post('/categories/create', authentication.isInRole('admin'), uploadCategoryImage.single('avatar'), controller.createCategory);
